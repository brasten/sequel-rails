...
sequel-rails supports the use of more than one database per environment across your models.
...
You can then set this database for a model using the following syntax:
...
Databases are only connected to once are defined in a Sequel::Model.
